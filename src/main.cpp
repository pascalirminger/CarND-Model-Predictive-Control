      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          *******************************************************************************/
          ...
          //std::cout << "mpc_result " << mpc_result << std::endl;

          /*******************************************************************************
          *  Define JSON object                                                          *
          *******************************************************************************/
          // Compute steering value and angle value
          const double steer_value = mpc_result[0] / deg2rad(25);  // Normalize to [-1, 1];
          const double throttle_value = mpc_result[1];
