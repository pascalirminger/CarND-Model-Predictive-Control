...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // Extract state values for better readibility
  ...
  // Set all non-actuators upper and lower limits to the max negative and
  // positive values
  ...
  // The upper and lower limits of delta are set to -25 to 25 degrees (radians)
